  ...
  return (
    <article className='flex justify-between w-full h-auto p-4 transition duration-300 transform bg-gray-100 shadow-lg rounded-xl hover:scale-105'>
      <div className='flex'>
        ...
        >
          <path
            d='M14.2398 2.0688C13.9331 1.76885 13.5172 1.60034 13.0835 1.60034C12.6499 1.60034 12.234 1.76885 11.9273 2.0688L5.72412 8.1376V10.4H8.03661L14.2398 4.3312C14.5464 4.03116 14.7186 3.62426 14.7186 3.2C14.7186 2.77574 14.5464 2.36884 14.2398 2.0688Z'
            fill='#3F3F46'
          />
          <path
            fillRule='evenodd'
