...
export default function Home() {
  return (
    <main className='w-full h-screen pt-16'>
      ...
      <div className='flex p-8 pt-10 space-x-8 overflow-hidden shadow-lg bg-gradient-to-b to-teal-600 from-blue-400 h-96'>
        <div className='w-3/5 space-y-2 text-gray-200'>
          <h1 className='text-5xl font-black'>Go on an adventure.</h1>
          <p className='text-lg leading-snug'>
            Going on trips with friends and loved ones is always a memorable
            experience, but coordinating and planning a trip with a group can be
      ...
      <div className='flex items-center justify-between p-8 pt-16 space-x-8'>
        <article className='flex flex-col w-1/2 h-auto p-4 transition duration-500 transform bg-gray-100 shadow-lg rounded-xl hover:scale-105'>
          <svg
          ...
          <p className='pb-4 text-sm'>
            ...
            stops to all the local attractions, and food breaks at the island's
            best eats.
          </p>
        </article>
        <div className='w-full'>
          <div className='flex-none w-full transform shadow-lg h-44 bg-gray-50 rounded-2xl rotate-3'></div>
          <div className='flex flex-col justify-center w-full p-6 space-y-2 text-gray-200 transform bg-teal-600 shadow-lg h-44 -mt-44 rounded-2xl'>
            ...
            <p className='text-xl leading-snug'>
              ...
              There are tons of trips to explore!
            </p>
          </div>
        </div>
      </div>
