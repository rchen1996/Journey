    ...
    <main className='flex flex-col justify-between w-full min-h-screen pt-16'>
      ...
      <div className='flex flex-col items-center justify-between p-8 pb-16 space-y-8 lg:pt-16 lg:px-24 xl:px-40'>
        <div className='flex mb-8 md:space-x-8'>
          ...
          {/* <article className='flex-col justify-between hidden w-full h-auto p-4 transition duration-500 transform bg-gray-100 shadow-lg xl:flex rounded-xl hover:scale-105'>
            <div>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 20 20'
              ...
              <div className='flex pt-2 pb-1.5 space-x-2 text-gray-200'>
                <div className='flex items-center justify-center px-2 py-1.5 bg-teal-600 shadow-md w-min whitespace-nowrap rounded-2xl'>
                  ...
                  <span className='text-xs font-bold'>10 Days</span>
                </div>
                <div className='flex items-center justify-center px-2 py-1.5 bg-teal-600 shadow-md w-min whitespace-nowrap rounded-2xl'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
              ...
              <div className='pb-2'>
                ...
                <p className='text-sm text-gray-500'>
                  Explore the diverse landscape of the American midwest from
                  prairie farmland, to the towering Rocky Mountains. Finally,
                  end your journey in the depths of the Grand Canyon.
                </p>
              </div>
            </div>
          </article> */}
